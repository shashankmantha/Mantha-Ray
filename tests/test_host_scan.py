...
class HostScanTests(unittest.TestCase):
    def test_valid_request_builds_hardened_read_only_mount(
        self,
    ) -> None:
    ...
    def test_parses_bounded_progress_event(
        self,
    ) -> None:
    ...
    def test_rejects_invalid_progress_event(
        self,
    ) -> None:
        event = parse_progress_event(
            json.dumps(
    ...
    def test_comma_in_mount_path_is_rejected(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            base = Path(temporary)
    ...
    def test_output_paths_are_derived_from_validated_case_id(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            case_id = (
                "case-20260915T120000Z-1234abcd"
            )
    ...
    def test_scanner_error_is_preserved(
        self,
    ) -> None:
        output = json.dumps(
            {
